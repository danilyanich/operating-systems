...
// OS3MFC.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(COS3MFCApp, CWinApp)
...
// Единственный объект COS3MFCApp

COS3MFCApp theApp;


// Инициализация COS3MFCApp

BOOL COS3MFCApp::InitInstance()
{
