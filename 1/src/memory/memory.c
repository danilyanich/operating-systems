        ...
        *error = M_ERR_OUT_OF_BOUNDS;
        ...
        for (int i = 0; i < NUMBER_OF_PAGES; i++) {
            ...
            if (counter == 0) {
                ...
                fillSeveralPages(write_from_buffer, first_bit_of_first_page, number_of_pages);
                *error = M_ERR_OK;
                return;
            }
        }
