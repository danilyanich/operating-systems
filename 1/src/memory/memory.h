...
typedef page* m_id; // Identifier of sandbox memory segment
...
void m_read(m_id read_from_id, void* read_to_buffer, m_err_code* error_code);
...
// @param error_code [out] M_ERR_OK, M_ERR_INVALID_CHUNK, M_ERR_OUT_OF_BOUNDS
m_id m_write(m_id write_to_id, void* write_from_buffer, int size_to_write, m_err_code* error_code);
...
memory* m_init(int size_of_page, m_err_code* error_code);
