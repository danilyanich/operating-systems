...
void m_read(m_id read_from_id, char* read_to_buffer, int size_to_read, m_err_code* error_code, int chunk_number);
...
// @param error_code [out] M_ERR_OK, M_ERR_INVALID_CHUNK, M_ERR_OUT_OF_BOUNDS
void m_write(m_id write_to_id, const void* write_from_buffer, int size_to_write, m_err_code* error_code);
